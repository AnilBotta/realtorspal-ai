...
- **CRM Dashboard (React)**: `https://draft-activity-mgr.preview.emergentagent.com`
- **Backend API (FastAPI)**: `https://draft-activity-mgr.preview.emergentagent.com/api`
...
# Test signup API
curl -X POST https://draft-activity-mgr.preview.emergentagent.com/api/auth/signup \
...
# Login
curl -X POST https://draft-activity-mgr.preview.emergentagent.com/api/auth/login \
  -H "Content-Type: application/json" \
  -d '{
    "email": "newuser@example.com",
    "password": "SecurePass123"
