...
- API calls go directly to: `https://draft-activity-mgr.preview.emergentagent.com/api`
...
4. Check browser Network tab:
   - Should see POST to `https://draft-activity-mgr.preview.emergentagent.com/api/auth/signup`
...
```bash
curl https://draft-activity-mgr.preview.emergentagent.com/api/health
...
```
✅ Correct: https://draft-activity-mgr.preview.emergentagent.com/api
❌ Wrong: https://draft-activity-mgr.preview.emergentagent.com/api/
```
...
- Verify backend is running: `curl https://draft-activity-mgr.preview.emergentagent.com/api/health`
